 ...
 */
/**
 * This object represents the definition of a long option in the Java port of GNU getopt. An array of LongOpt objects is passed to
 * the Getopt object to define the list of valid long options for a given parsing session. Refer to the getopt documentation for
 * details on the format of long options.
 *
 * @version 1.0.5
...
public class LongOpt extends Object {
	...
	/**
	 * Constant value used for the "has_arg" constructor argument. This value indicates that the option takes an argument that is
	 * required.
	 */
	...
	/**
	 * If this variable is not null, then the value stored in "val" is stored here when this long option is encountered. If this is
	 * null, the value stored in "val" is treated as the name of an equivalent short option.
	 */
	 ...
	 */
	/**
	 * Create a new LongOpt object with the given parameter values. If the value passed as has_arg is not valid, then an exception
	 * is thrown.
	 *
	 * @param name
	 *            The long option String.
	 * @param has_arg
	 *            Indicates whether the option has no argument (NO_ARGUMENT), a required argument (REQUIRED_ARGUMENT) or an optional
	 *            argument (OPTIONAL_ARGUMENT).
	 * @param flag
	 *            If non-null, this is a location to store the value of "val" when this option is encountered, otherwise "val" is
	 *            treated as the equivalent short option character.
	 * @param val
