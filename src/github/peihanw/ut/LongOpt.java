 ...
 */
/**
 * This object represents the definition of a long option in the Java port of
 * GNU getopt. An array of LongOpt objects is passed to the Getopt object to
 * define the list of valid long options for a given parsing session. Refer to
 * the getopt documentation for details on the format of long options.
 *
 * @version 1.0.5
